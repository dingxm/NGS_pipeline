...
print $stats{'num_fail_pos'} . " had a position near the ends of most supporting reads (position < $min_read_pos)\n";
...
print $stats{'num_pass_filter'} . " passed all filters\n";
print $stats{'num_no_readcounts'} . " had no readcounts for the variant allele\n";
